            ...
            <div className="grid h-full min-h-[760px] sm:min-h-[650px] xl:min-h-[560px] xl:grid-cols-[360px_minmax(0,1fr)]">
              ...
              <div className="relative p-6 sm:p-8">
                ...
                <div className="mt-7 grid gap-4 md:grid-cols-2">
                  <PassportField label={t('forms.fields.lastName')} value={valueOrEmpty(getString(employee.last_name), t)} />
                  <PassportField label={t('forms.fields.firstName')} value={valueOrEmpty(getString(employee.first_name), t)} />
                  <PassportField label={t('forms.fields.middleName')} value={valueOrEmpty(getString(employee.middle_name), t)} />
          ...
          <article className="absolute inset-0 overflow-hidden rounded-[34px] border border-slate-200 bg-white shadow-sm [backface-visibility:hidden] [transform:rotateY(180deg)]">
            <div className="grid h-full min-h-[760px] sm:min-h-[650px] xl:min-h-[560px] xl:grid-cols-[minmax(0,1fr)_360px]">
              <div className="relative p-6 sm:p-8">
                ...
                <div className="mt-7 grid gap-4 md:grid-cols-2">
                  <PassportField label={t('forms.fields.addressCountry')} value={valueOrEmpty(getString(employee.address_country), t)} />
                  <PassportField label={t('forms.fields.addressCity')} value={valueOrEmpty(getString(employee.address_city), t)} />
                  <PassportField label={t('forms.fields.addressStreet')} value={valueOrEmpty(getString(employee.address_street), t)} />
                  <PassportField label={t('forms.fields.addressHouse')} value={valueOrEmpty(getString(employee.address_house), t)} />
                  <PassportField label={t('forms.fields.addressApartment')} value={valueOrEmpty(getString(employee.address_apartment), t)} />
                  <PassportField label={t('forms.fields.address')} value={valueOrEmpty(getString(employee.address), t)} />
                  <PassportField label={t('forms.fields.note')} value={valueOrEmpty(getString(employee.note), t)} />
                </div>
              </div>
