...
function getDefaultPath(permissionCodes: string[], employeeId: number): string {
  ...
  if (
    permissionCodes.includes("enterprises.view") ||
    permissionCodes.includes("departments.view") ||
    permissionCodes.includes("positions.view")
  ) {
    return "/enterprises";
  }
  if (permissionCodes.includes("directory.view")) return "/my-enterprise";
  ...
  if (permissionCodes.includes("analytics.view")) return "/analytics";
  if (permissionCodes.includes("filters.use")) return "/filters";
  if (
    permissionCodes.includes("data_exchange.import") ||
    permissionCodes.includes("data_exchange.export")
  ) {
    return "/data-exchange";
  }
  if (permissionCodes.includes("vacation_types.view")) return "/vacation-types";
  if (permissionCodes.includes("document_types.view")) return "/document-types";
