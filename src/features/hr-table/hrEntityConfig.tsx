...
const hrEntityConfigDefinitions: Record<
  HrEntityKey,
  HrEntityPageConfigDefinition
> = {
  enterprises: {
    entity: "enterprises",
    ...
    columns: [
      {
        key: "name",
        labelKey: "entities.enterprises.columns.name",
  ...
  employees: {
    ...
    columns: [
      ...
      {
        key: "status",
        labelKey: "entities.employees.columns.status",
        format: "status",
      },
    ],
  },
    ...
    columns: [
      {
        ...
        labelKey: "entities.employeeEducation.columns.institution",
      },
      {
        key: "education_degree",
        labelKey: "entities.employeeEducation.columns.degree",
      },
      {
        key: "speciality",
        labelKey: "entities.employeeEducation.columns.speciality",
      },
      {
        key: "started_at",
        labelKey: "entities.employeeEducation.columns.startedAt",
        format: "date",
      },
      {
        key: "ended_at",
        labelKey: "entities.employeeEducation.columns.endedAt",
        format: "date",
      },
    ],
  },
  ...
  employee_experience: {
    ...
    columns: [
      {
        key: "company_name",
        labelKey: "entities.employeeExperience.columns.company",
      },
      {
        key: "position_name",
        labelKey: "entities.employeeExperience.columns.position",
      },
      {
        key: "started_at",
        labelKey: "entities.employeeExperience.columns.startedAt",
        format: "date",
      },
      {
        key: "ended_at",
        labelKey: "entities.employeeExperience.columns.endedAt",
        format: "date",
      },
    ],
  },
  ...
  employment_history: {
    ...
    columns: [
      ...
      {
        key: "new_salary",
        labelKey: "entities.employmentHistory.columns.salary",
        format: "money",
      },
      {
        key: "effective_at",
        labelKey: "entities.employmentHistory.columns.effectiveAt",
        format: "date",
      },
  ...
  departments: {
    ...
    columns: [
      ...
      {
        key: "created_on",
        labelKey: "entities.departments.columns.createdOn",
        format: "date",
      },
  ...
  positions: {
    ...
    columns: [
      ...
      {
        key: "base_salary",
        labelKey: "entities.positions.columns.baseSalary",
        format: "money",
      },
      {
        key: "allowance",
      ...
      {
        key: "requirements",
        labelKey: "entities.positions.columns.requirements",
      },
    ],
  },
  ...
  vacations: {
    ...
    columns: [
      ...
      {
        key: "starts_at",
        labelKey: "entities.vacations.columns.startsAt",
        format: "date",
      },
      {
        key: "ends_at",
        labelKey: "entities.vacations.columns.endsAt",
        format: "date",
      },
